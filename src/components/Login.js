...
import authImage from './auth.jpg'; // Assuming auth.jpg is in the same directory
...
const Login = () => {
  ...
  const primaryButtonHoverShadow = "0px 0px 15px rgba(59, 130, 246, 0.5)";

  return (
    // Main page container - UPDATED to a light blue gradient background
        ...
        <div className="w-full lg:w-[45%] xl:w-2/5 p-6 sm:p-8 md:p-10 flex flex-col justify-center">
          ...
          <div className="w-full max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
            ...
            <p className="text-center text-sm text-gray-600 mt-6">
              ...
              <Link to="/signup" className="font-medium text-amber-600 hover:text-amber-700 hover:underline">
                Sign up here
              </Link>
            </p>
          </div>
